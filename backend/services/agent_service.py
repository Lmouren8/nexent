...
async def import_agent_by_agent_id(
    ...
    if import_agent_info.max_steps <= 0 or import_agent_info.max_steps > 50:
        raise ValueError(
            f"Invalid max steps: {import_agent_info.max_steps}. max steps must be greater than 0 and less than 50.")
